...
This project is a continuation of querying database using SQL. In this part, creating user, granting privileges, performing joins and constraints incorporation was examined.
