...
This projects examined the concept of object oriented programming(OOP) and its importance in the structuring and reusing of code. It difference with the procedural of functional style of programming was looked into. Classes, Objects, instance variable, public and private attributes, methods, setters and getters were also examined. Furthermore, Four important concept in OOPS: Encapsulation, abstraction, inheritance and Polymorphism were briefly explained.
