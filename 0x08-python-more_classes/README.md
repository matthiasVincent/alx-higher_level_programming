...
This project is a continuation of python classes. Aside thw concepts looked into in the firt part, static methods like __str__, __del__, __repr__ were examined. Class and instance attributes were expanded too.
