...
This project examined the concept of inheritance in python. The concept of super and subclasses were looked into. Also, class methods and attributes were critically examined.

## Tests :heavy_check_mark:

* [tests](./tests): Folder of test files. Includes both the  ones provided by ALX
