...
This project looked into file handling.Reading from and writing to files were examined together with serialization and deserialization of JSON files using json module.
