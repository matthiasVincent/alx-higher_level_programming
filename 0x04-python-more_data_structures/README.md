...
This particular project dive deeper into the ocean of data structures. In this project, dictionary, sets and their specific built-in methods and applications were elaborately looked into. In addition, some important built-in methods: `lambda`, `map`, `filter` and `reduce` were briefly explained.
