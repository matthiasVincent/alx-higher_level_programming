...
In this project, I put into use the  skills I acquired in Python object-oriented programming
(OOP) paradigm by coding three connected classes to represent rectangles and squares. I wrote my
